...
from physics import A_to_a0, ea0_to_D, pm_to_a0, eV_to_Eh
...
def CDFT_plus_Indices(j_data_opt, j_data_spplus):
    Eref = j_data_opt[0]["results"]["wavefunction"]["total_molecular_energy"]
    Eplus = j_data_spplus[0]["results"]["wavefunction"]["total_molecular_energy"]

    A = (Eref-Eplus)*eV_to_Eh

    OPT_charges = np.array(j_data_opt[0]["results"]["wavefunction"]["Mulliken_partial_charges"])
    SPplus_charges = np.array(j_data_spplus[0]["results"]["wavefunction"]["Mulliken_partial_charges"])
    fplus_lambda_mulliken = np.subtract(OPT_charges, SPplus_charges)
    
    OPT_charges = np.array(j_data_opt[0]["results"]["wavefunction"]["Hirshfeld_partial_charges"])
    SPplus_charges = np.array(j_data_spplus[0]["results"]["wavefunction"]["Hirshfeld_partial_charges"])
...
def CDFT_minus_Indices(j_data_opt, j_data_spminus):
    Eref = j_data_opt[0]["results"]["wavefunction"]["total_molecular_energy"]
    Eminus = j_data_spminus[0]["results"]["wavefunction"]["total_molecular_energy"]
    
    I = (Eminus-Eref)*eV_to_Eh

    OPT_charges = np.array(j_data_opt[0]["results"]["wavefunction"]["Mulliken_partial_charges"])
    SPminus_charges = np.array(j_data_spminus[0]["results"]["wavefunction"]["Mulliken_partial_charges"])
    fminus_lambda_mulliken = np.subtract(OPT_charges, SPminus_charges)

    OPT_charges = np.array(j_data_opt[0]["results"]["wavefunction"]["Hirshfeld_partial_charges"])
    SPminus_charges = np.array(j_data_spminus[0]["results"]["wavefunction"]["Hirshfeld_partial_charges"])
